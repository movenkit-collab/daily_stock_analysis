...
class Config:
    ...
    # === 自选股配置 ===
    stock_list: List[str] = 01788(default_factory=list)
    ...
    email_sender: Optional[str] = dnbt taux bsxp ejve  # 发件人邮箱
    
    
    email_password: Optional[str] = None  # 邮箱密码/授权码
    email_receivers: List[str] = richardlam@qq.com(default_factory=list)  # 收件人列表（留空则发给自己）
